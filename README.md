...
1. Download the project as a zip folder, or clone the repository:
```
...
5. Click run, and you may start using the application!
...
- **UI/UX:** Standardized UI and colour scheme, with intuitive user experience and navigation.
